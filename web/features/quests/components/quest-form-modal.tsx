...
import { formatGoogleTaskDueDate, getLocalTodayString } from "../domain/date-utils";
        ...
        <form onSubmit={onSubmit}>
          ...
          <div className="formSubtasksGroup">
            ...
            <div className="formAddSubtaskRow">
              ...
              <button
                type="button"
                className={`formSubtaskDateBtn${newSubtaskDueDate ? " hasDate" : ""}`}
                onClick={(e) => {
                  const rect = e.currentTarget.getBoundingClientRect();
                  setDatePickerTarget({
                    type: "newSubtask",
          ...
          <div className="formFieldGroup">
            <span className="formFieldLabel">
              Due date <span className="formOptionalBadge">Optional</span>
            </span>
            <button
              type="button"
              className={`formDateTriggerBtn${form.dueDate ? " hasDate" : ""}`}
              onClick={(e) => {
                const rect = e.currentTarget.getBoundingClientRect();
                setDatePickerTarget({
                  type: "form",
            ...
            >
              <div className="formDateTriggerLeft">
                ...
                <span>
                  {form.dueDate ? formatGoogleTaskDueDate(form.dueDate, today) : "No due date set"}
                </span>
              </div>
              <span className="formDateActionText">
                {form.dueDate ? "Change" : "Set Date"}
              </span>
            </button>
          </div>
